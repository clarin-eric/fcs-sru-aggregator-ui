...
- [ReactJS](https://18.react.dev/) 18.3.1
  ...
  - [React Query](https://tanstack.com/query/latest) 5.85.3 with [Axios](https://github.com/axios/axios) 1.11.0 for web requests
...
- [Vite](https://vite.dev/) 7.1.2 with plugins
