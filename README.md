...
- [ReactJS](https://18.react.dev/) 18.3.1
  - [React Router](https://reactrouter.com/start/library/installation) ("library") 7.7.1 for <abbr title="Single Page Application">SPA</abbr> routing
  - [React Query](https://tanstack.com/query/latest) 5.84.1 with [Axios](https://github.com/axios/axios) 1.11.0 for web requests
...
- [Vite](https://vite.dev/) 7.0.6 with plugins
