...
- [ReactJS](https://18.react.dev/) 18.3.1
  ...
  - [React Query](https://tanstack.com/query/latest) 5.100.ß with [Axios](https://github.com/axios/axios) 1.16.0 for web requests
...
- [Zustand](https://github.com/pmndrs/zustand) 5.0.12 for state management of external bundle configuration
...
- [Vite](https://vite.dev/) 7.3.1 with plugins
  ...
  - [picomatch](https://github.com/micromatch/picomatch#globbing-features) 4.0.4 for filename filters in output control
- [TypeScript](https://www.typescriptlang.org/) 5.9.3 with `@types/*` definitions
- [ESLint](https://eslint.org/) 9.39.2 with plugins
- [simple-git](https://github.com/steveukx/git-js) 3.36.0 for source code information
