...
- [ReactJS](https://18.react.dev/) 18.3.1
  ...
  - [React Query](https://tanstack.com/query/latest) 5.97.0 with [Axios](https://github.com/axios/axios) 1.15.0 for web requests
...
- [simple-git](https://github.com/steveukx/git-js) 3.35.2 for source code information
