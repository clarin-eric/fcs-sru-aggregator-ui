...
- [ReactJS](https://18.react.dev/) 18.3.1
  - [React Router](https://reactrouter.com/start/library/installation) ("library") 7.5.1 for <abbr title="Single Page Application">SPA</abbr> routing
  - [React Query](https://tanstack.com/query/latest) 5.74.4 with [Axios](https://github.com/axios/axios) 1.8.4 for web requests
...
- [Vite](https://vite.dev/) 6.3.2 with plugins
